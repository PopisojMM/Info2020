...
while flag:
    ...
    if (valor1 == 0 or valor2 == 0):
        print ("\n\033[1;31m"+"Error, solo puede ingresar números mayores a 0""\033[1;37m\n") 
    ...
    x = input("Si desea terminar ingrese el número 1, de lo contrario pulse Intro.\n")
    if x == "1":
        flag = False
        print("\n\t\t\t\n\033[1;33mGracias por utilizar el programa")
        print("\n\tG8 INFO2020\033[1;37m")
'''
    -----------------------------------------------------------------
    Ejercicio Desafío.
...
print ("\nBienvenido, calcule la suma de los digitos que componen su número\n")
contadorpares = 0
sumadigitos, extNum = 0, 0
numeroentero = int(input("Ingrese un numero entero: "))
while numeroentero != 0:
    extNum = numeroentero % 10
    numeroentero //= 10
    sumadigitos += extNum
    if numeroentero % 2 == 0:
        contadorpares = contadorpares+1
print(f"La suma de los digitos es {sumadigitos} y {contadorpares} de los números son pares")